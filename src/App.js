  ...
  return (
    ...
    <div className="flex flex-nowrap md:flex-wrap">
      ...
      <div className="w-full md:w-4/5 order-2 md:order-2">
        ...
        <div
          id="home"
          className="w-full h-screen md:min-h-screen bg-cover bg-no-repeat bg-opacity-50 bg-center order-2  bg-pink-50"
          style={{
            backgroundImage: `url(${hands})`,
          }}
        >
          <div className="fixed mt-8 z-20  ml-7 md:hidden">
            <button
          ...
          <div className="w-full h-screen md:min-h-screen flex justify-center items-center bg-gray-900 bg-opacity-50">
