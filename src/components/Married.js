...
const Married = () => {
  ...
  return (
    <div
      id="matrimonio"
      className="w-full h-screen md:min-h-screen bg-fixed  bg-no-repeat bg-center  md:bg-cover order-3 "
      style={{
    ...
    >
      <div className="w-full h-screen  bg-opacity-50 bg-black ">
        <div className="h-1/2 text-center w-full bg-white  flex flex-col justify-center items-center">
          <h2 className="font-bold text-2xl sm:text-2xl xl:text-3xl mt-4  xl:mt-0 mb-4 tracking-widest">
            ¡Llegó el día!
          </h2>
          <h2 className="text-base xl:text-2xl mb-2 xl:mb-6 text-center lg:w-3/4">
            ...
            la celebración de nuestra boda. Deja todo lo que tengas que hacer el
            domingo <strong>28 de Noviembre</strong> y únete a nosotros.
          </h2>
